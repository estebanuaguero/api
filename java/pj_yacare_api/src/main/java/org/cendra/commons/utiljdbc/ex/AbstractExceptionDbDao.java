...
import org.cendra.commons.utiljdbc.DataSourceMetaData;

public abstract class AbstractExceptionDbDao extends AbstractExceptionDao {

	private static final long serialVersionUID = 5429707973404928220L;
	...
	public AbstractExceptionDbDao(String subject, Class throwerClass,
			String message, Exception thirdException,
			ConnectionWrapper connectionWrapper, String operationType) {

		super(subject, throwerClass, message, thirdException);
