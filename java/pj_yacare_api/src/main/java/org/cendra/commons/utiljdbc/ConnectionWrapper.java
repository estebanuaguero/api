...
import org.cendra.commons.utiljdbc.ex.ExBeginDao;
import org.cendra.commons.utiljdbc.ex.ExCloseConnection;
import org.cendra.commons.utiljdbc.ex.ExCommitDao;
import org.cendra.commons.utiljdbc.ex.ExRollBackDao;
...
//			ex.setFirstTrace(e, this.getClass());
	...
	// public ResultList findToResultList(String sql, String sqlCount, int
	// offSet, int limit, Object... args) {
	// return utilJdbc.findToResultList(this, sql, sqlCount, offSet, limit,
	// args);
	// }
