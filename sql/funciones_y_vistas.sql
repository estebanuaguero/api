...
-- SELECT * FROM yacare.v_geo_location;
...
-- SELECT * FROM yacare.v_identity_type;	
...
-- SELECT * FROM yacare.v_legal_guardian LIMIT 100;
...
-- SELECT * FROM yacare.v_student LIMIT 100;
